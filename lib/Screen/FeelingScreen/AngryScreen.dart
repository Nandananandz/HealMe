      ...
      child: Scaffold(
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              SizedBox(height: 2.h,),
                 Column(
                   ...
                   Text("Angry😡",style: GoogleFonts.epilogue(color:Colors.black,fontSize: 16.sp,fontWeight: FontWeight.w800 ),)
            ...
            SizedBox(height: 3.h,)   ,
             QuoteCard(textdata: "“Holding onto anger is like drinking poison and expecting the other person to die.”") ,
                     SizedBox(height: 3.h,)   ,
                     RepeatContainer(Headertext: "Talk to Someone", describetext: "Let’s talk about it, Calm ways 101, Mindful positivity. And we clean them up with technology.Share your thoughts our friend or a chat bot", goto: "Know more", ctColor: Colors.red.shade100)
